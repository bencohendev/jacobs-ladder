<script>
	...
	import UserIcon from '$c/UserIcon.svelte';
</script>

<div class="flex h-40 mt-2">
	{#each score as card, i}
		{@const { rowOne, rowTwo, rowThree, user } = card}
		<div
			class="p-2 mx-2 border border-gray-300 
			{i === currentCard ? 'bg-green-500' : ''} "
		>
